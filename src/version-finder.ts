...
export type VersionEntry = {
  ...
  export async function getLatestKnownVersion(knownVersionFilePath: string): Promise<VersionEntry | null> {
    try {
        ...
        console.error(`Failed to use fallback version: ${(fallbackError instanceof Error) ? fallbackError.message : "Unknown"}`);
        return null;
    }
}
